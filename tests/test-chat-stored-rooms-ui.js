...
assert.match(panel, /class="chat-inactive-resume"[\s\S]{0,300}uiIcon\('play'\)/);
...
assert.doesNotMatch(panel, /label:'Magic Link'/, "Room cards must not duplicate the Settings-owned Magic Link action");
