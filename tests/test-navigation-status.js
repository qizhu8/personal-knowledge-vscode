...
assert.match(extension, /personalKnowledge\.openServerLink/);
assert.match(extension, /openServerPanel\(context, String\(slug \|\| ""\)\)/);
assert.match(extension, /command: "focusServer", slug/);
assert.match(manifest, /"command": "personalKnowledge\.openServerLink"/);
