...
const sources = {
  skills: [{ _key: "Coding/Local Skill", name: "Local Skill", description: "Local procedure", content: "skill body", category: "Coding", tags: '["local"]' }],
...
assert.match(extension, /scheduleRetrievalRefresh\(context, 0\)/, "activation/runtime setup must submit the initial snapshot");
